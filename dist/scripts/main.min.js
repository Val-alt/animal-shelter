...
var App={options:{},init:function(){this.animateScroll(),this.pricesToggle()},animateScroll:function(){$("body").on("click","a",function(t){var i=t.target.getAttribute("href");if(console.log(i),0!=i.indexOf("tel")&&0!=i.indexOf("mailto")){t.preventDefault();var o=$(this).attr("href"),n=$(o).offset().top;window.matchMedia("(max-width: 900px)").matches&&(n-=60),console.log(n),$("body,html").animate({scrollTop:n},1500)}})},pricesToggle:function(){$(".navigation-mob__btn").click(function(){0===$(this).parents(".navigation-mob").find(".navigation-mob__block").height()?App.autoHeightAnimate($(this).parents(".navigation-mob").find(".navigation-mob__block"),300):$(this).parents(".navigation-mob").find(".navigation-mob__block").stop().animate({height:"0"},300)}),document.querySelector(".navigation-mob__block").onmouseleave=(()=>{window.matchMedia("(max-width: 900px)").matches&&$(".navigation-mob__block").stop().animate({height:"0"},300)}),window.onscroll=function(){$(".navigation-mob__block").stop().animate({height:"0"},0)}},autoHeightAnimate:function(t,i){var o=t.height();t.height(o),t.stop().animate({height:200},i)}};$(document).ready(function(){App.init()});